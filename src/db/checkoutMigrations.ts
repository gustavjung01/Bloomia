...
export const checkoutMigrations: Migration[] = [
  ...
  },
  {
    ...
    statements: [
      ...
      "UPDATE sales SET sale_status = 'completed' WHERE sale_status IS NULL OR sale_status = ''",
      "UPDATE sales SET finalized_at = COALESCE(finalized_at, sale_date) WHERE sale_status = 'completed'",
