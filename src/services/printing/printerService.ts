...
export async function printInvoiceHtml(markup: string, printerName?: string | null, paperSize: PaperSize = '80mm') {
...
export async function testPrint(printerName?: string | null, paperSize: PaperSize = '80mm') {
